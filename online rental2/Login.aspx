<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="online_rental2.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            <center>
                <h3 class="auto-style1"><span class="auto-style11">USER LOGIN</span> </h3>
            </center>
            <br />
            <br />
